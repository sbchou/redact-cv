...
def test_count():
    ...
    param_grid = {'min_width_ratio': [0.01, 0.04, 0.05, 0.06, 0.07, 0.08, 0.1], 
                'max_width_ratio': [0.80, 0.85, 0.90], 
                'min_height_ratio': [0.01, 0.04, 0.05, 0.06, 0.07, 0.08, 0.1],
                'max_height_ratio': [0.80, 0.85, 0.90, 0.95]} 
...
score, correct = grid_search.count_scoring(training, '../train_dark/', 
